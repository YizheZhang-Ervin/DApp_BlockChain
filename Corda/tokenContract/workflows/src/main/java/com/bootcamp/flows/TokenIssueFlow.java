...
public class TokenIssueFlow {
    ...
    public static class TokenIssueFlowInitiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            List<PublicKey> registeredSigners = ImmutableList.of(TokenState.getIssuer().getOwningKey(),owner.getOwningKey())
            transactionBuilder.addCommand(command,registeredSigners)
